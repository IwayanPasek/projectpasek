...
<head>
    ...
    <style>
        ...
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 15px; background-color: #f4f4f9; color: #333; }
        h2 { color: #4a4a4a; text-align: center; margin-bottom: 20px; }
        a { text-decoration: none; color: #007bff; }
        a[href="index.php"] { display: block; width: fit-content; margin: 0 auto 25px auto; padding: 10px 20px; background-color: #28a745; color: white; border-radius: 5px; font-weight: bold; text-align: center; }
        ...
        td form { display: flex; flex-direction: column; margin-bottom: 8px; }
        input[type="number"] { padding: 8px; margin-bottom: 5px; border: 1px solid #ccc; border-radius: 4px; width: 100%; box-sizing: border-box; }
        button, a[target="_blank"] { padding: 8px 12px; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; text-align: center; display: inline-block; width: 100%; box-sizing: border-box; }
        button[type="submit"] { background-color: #17a2b8; color: white; }
        form[action='proses/tandai_selesai.php'] button { background-color: #ffc107; color: #212529; }
        a[target="_blank"] { background-color: #28a745; color: white; margin-top: 5px; }
        @media screen and (max-width: 600px) {
            body { padding: 10px; }
            table, thead, tbody, th, td, tr { display: block; }
            thead tr { position: absolute; top: -9999px; left: -9999px; }
            tr { border: 1px solid #ccc; margin-bottom: 15px; border-radius: 5px; overflow: hidden; }
            td { border: none; border-bottom: 1px solid #eee; position: relative; padding-left: 45%; min-height: 30px; text-align: right; }
            td:before { position: absolute; left: 10px; width: 40%; padding-right: 10px; white-space: nowrap; text-align: left; font-weight: bold; color: #555; }
